...
public class DialogPrompt {
	 ...
	 * 
	 * @param context
	 *            the context which is requesting the prompt
	 * @param message
	 ...
	 *            the message to display
	 * @param pButton
	 *            the text of positive button
	 * @param pListener
	 *            the OnClickListener for positive button
	 * @param nButton
	 *            the text of negative button
	 * @param nListener
	 *            the OnClickListener for negative button
	 */
	 ...
	 * @param firstListener
	 *            the OnClickListener for first button
	 * @param secondButton
	 *            the text of second button
	 * @param secondListener
	 *            the OnClickListener for second button
	 * @param thirdButton
	 *            the text of third button
	 * @param thirdListener
	 *            the OnClickListener for third button
	 */
	public static boolean showOptionDialog(Context context, String message,
			String firstButton, DialogInterface.OnClickListener firstListener,
			String secondButton,
			DialogInterface.OnClickListener secondListener, String thirdButton,
	...
	public static void showAppAboutDialog(Context ctx) {
		...
		TextView version = (TextView) dialog
				.findViewById(R.id.about_dialog_version);
		version.setText("App version " + ctx.getString(R.string.version_name));

		// set up scrollview
		ScrollView scroller = (ScrollView) dialog
				.findViewById(R.id.about_dialog_scrollview);
		scroller.getLayoutParams().height = 200;

		// set up button
		Button button = (Button) dialog
				.findViewById(R.id.about_dialog_okbutton);
