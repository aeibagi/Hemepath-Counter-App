...
public class NewCounterActivity extends Activity implements View.OnClickListener, ExpandableListView.OnChildClickListener{
	...
	private void initializePredefinedCells() 
	{
        ...
        arrayChildren2.add(getResources().getString(R.string.atypicalLymphocytes));
        ...
        arrayChildren2.add(getResources().getString(R.string.white_Blodd_Cells));
        arrayChildren2.add(getResources().getString(R.string.Plasma_cells));
        arrayChildren2.add(getResources().getString(R.string.Atypical_plasma_cells));
        ...
        arrayChildren3.add(getResources().getString(R.string.Reed_Sternberg_cells));
        
        // add children to Low_yield_additional panel
        arrayChildren4.add(getResources().getString(R.string.Atypical_eosinophils));
        arrayChildren4.add(getResources().getString(R.string.Atypical_basophils));
        arrayChildren4.add(getResources().getString(R.string.Atypical_neutrophils));
        arrayChildren4.add(getResources().getString(R.string.Atypical_megakaryocytes));
        arrayChildren4.add(getResources().getString(R.string.Megakaryoblasts));
        arrayChildren4.add(getResources().getString(R.string.Basophilic_normoblasts));
        arrayChildren4.add(getResources().getString(R.string.Orthochromatophilic_normoblasts));
